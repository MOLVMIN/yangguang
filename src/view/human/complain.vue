      ...
      <TabPane label="我的申请列表" name="name1">
        <Card>
          <div class="search-con">
            ...
            <Button v-for="item in permissionBtns" v-if="item.p_id === 110" @click="handleAdd" class="add-btn" type="primary">{{ item.p_name }}</Button>
          </div>
          <Table
            ref="tablesAsk"
            :data="tableData"
          ...
          {title: '调整后薪资', align: 'center', key: 'us_new_salary'},
          {
            ...
            render: (h, params) => {
              ...
              for (var i = 0; i < this.handleBtns.length; i++) {
                ...
                } else if (this.handleBtns[i].p_id === 112) {
                  btns.push(h('Button', {
                    props: {
                      type: 'info',
                      size: 'small'
                ...
                } else if (this.handleBtns[i].p_id === 113) {
                  btns.push(h('Button', {
                    props: {
                      type: 'error',
                      size: 'small',
                ...
                } else if (this.handleBtns[i].p_id === 114) {
                  btns.push(h('Button', {
                    props: {
                      type: 'warning',
                      size: 'small',
                ...
                } else if (this.handleBtns[i].p_id === 115) {
                  btns.push(h('Button', {
                    props: {
                      type: 'success',
                      size: 'small',
      ...
      getPermissionBtns: function () {
        ...
        for (var item of common.permission) {
          if (item.p_fid === this.$route.meta.id) {
            ...
            if (item.p_id === 111 || item.p_id === 112 || item.p_id === 113 || item.p_id === 114 || item.p_id === 115) {
