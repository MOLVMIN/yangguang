  ...
  <div>
    <Card>
      <div style="height: 40px;">
        <Button v-for="item in permissionBtns" v-if="item.p_id === 14" @click="updateBtn" class="add-btn" type="primary">{{ item.p_name }}</Button>
      </div>
    ...
    <Modal width="800" v-model="showModal" :mask-closable="false">
      ...
      <div slot="footer">
        <Button v-for="item in permissionBtns" v-if="item.p_id === 14" type="info" size="large" @click="updateArticles(item.p_path)">保存</Button>
