...
export const dateToStr = (date, strType) => {
  ...
  let resStr = ''
  if (strType === 'yyyy-MM-dd') resStr = year + '-' + month + '-' + day
  else if (strType === 'yyyy-MM-dd hh:MM:ss') resStr = year + '-' + month + '-' + day + ' ' + hours + ':' + minutes + ':' + second
  else resStr = year + '-' + month + '-' + day
  return resStr
}
